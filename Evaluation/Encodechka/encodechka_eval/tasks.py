...
from .task_specific_evaluators import (
    eval_accuracy_multiotput,
    eval_auc_multiotput,
    eval_pairs_clf_multiotput,
    eval_pairs_multiotput,
    evaluate_ner_embedder,
)
...
class SentimentTask(EncoderTask):
    def __init__(
        self, train_filename="data/SentiRuEval2016_small_train.csv", test_filename="data/SentiRuEval2016_small_test.csv"
    ):
